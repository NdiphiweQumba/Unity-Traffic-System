...
{
    public float maxSteerAngle   => GetComponent<SimpleCarController>().maxSteerAngle;
    public float maxMotorTorque  => GetComponent<SimpleCarController>().maxTorque;
    public float maxBrakeTorque  => GetComponent<SimpleCarController>().MaxBrakeTorque;
    ...
    private void FixedUpdate()
    {
        ...
        GetComponent<SimpleCarController>().Drive(steerAngle, motorTorque, brakeTorque);
    }
    ...
    {
        foreach (VehicleInfo info in GetComponent<SimpleCarController>().VehicleInfo)
        {
